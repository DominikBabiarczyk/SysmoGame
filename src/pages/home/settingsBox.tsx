        ...
        <div className="bg-orange-500 p-6 rounded-3xl shadow-lg max-w-sm text-center border-4 border-colors-white">
          <div className="flex items-center justify-between p-2">
            ...
            <div className="flex space-x-2 px-5">
              <img onClick={() => changeLanguage('pl')} src="/images/flags/poland.png" alt="Polish Flag" className="h-6 w-10 rounded" />
              <img onClick={() => changeLanguage('en')} src="/images/flags/england.png" alt="UK Flag" className="h-6 w-10 rounded" />
            </div>
          </div>
